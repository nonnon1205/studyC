...
/* ============================================================================
 * Metrics Collector Internal State (opaque pointer implementation)
 * ============================================================================
 */
...
{
    struct MetricsCollector* mc = (struct MetricsCollector*)malloc(sizeof(struct MetricsCollector));
    if (!mc) return NULL;

    memset(mc, 0, sizeof(struct MetricsCollector));
